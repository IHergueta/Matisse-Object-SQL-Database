 ...
 * Generation date: Fri Jan 15 12:27:44 2021
 */
...
public class DatosProfesionales extends com.matisse.reflect.MtObject {
    ...
    /* Attribute 'salario_bruto_anual' */

    /** Attribute <code>salario_bruto_anual</code> cache ID */
    private static int salario_bruto_anualCID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtAttribute.Loader("salario_bruto_anual",CID));

    /**
     * Gets the <code>salario_bruto_anual</code> attribute descriptor.
     * This method supports advanced MATISSE programming techniques such as
     * dynamically modifying the schema.
     * @param db the database containing the attribute
     * @return the attribute descriptor object
     */
    public static com.matisse.reflect.MtAttribute getSalario_bruto_anualAttribute(com.matisse.MtDatabase db) {
        return (com.matisse.reflect.MtAttribute)db.getCachedObject(salario_bruto_anualCID);
    }


    /**
     * Gets the <code>salario_bruto_anual</code> attribute value.
     * @return the value
     *
     * @see #setSalario_bruto_anual
     * @see #removeSalario_bruto_anual
     */
    public final float getSalario_bruto_anual() {
        return getFloat(getSalario_bruto_anualAttribute(getMtDatabase()));
    }

    /**
     * Sets the <code>salario_bruto_anual</code> attribute value.
     * @param val the new value
     *
     * @see #getSalario_bruto_anual
     * @see #removeSalario_bruto_anual
     */
    public final void setSalario_bruto_anual(float val) {
        setFloat(getSalario_bruto_anualAttribute(getMtDatabase()), val);
    }

    /**
     * Removes the current <code>salario_bruto_anual</code> attribute value.
     * Falls back to the default value is there is one.  If the attribute
     * has no default value, it must be set to a new value before commit.
     *
     * @see #getSalario_bruto_anual
     * @see #setSalario_bruto_anual
     */
    public final void removeSalario_bruto_anual() {
        removeValue(getSalario_bruto_anualAttribute(getMtDatabase()));
    }
     ...
     * @see #setSalario_bruto_anual
     */
    public final boolean isSalario_bruto_anualDefaultValue() {
        return isDefaultValue(getSalario_bruto_anualAttribute(getMtDatabase()));
    }
